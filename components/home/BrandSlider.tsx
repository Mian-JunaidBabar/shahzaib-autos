  ...
  return (
    <section className="py-12 bg-white/50 dark:bg-background-dark/50 border-y border-primary/10">
      <div className="max-w-7xl mx-auto px-4">
        <h3 className="text-center text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-16 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
          {brands.map((brand, idx) => (
            ...
            >
              <div className="w-10 h-10 bg-slate-100 dark:bg-slate-800 rounded-lg flex items-center justify-center shadow-sm group-hover:bg-primary/10 transition-colors">
